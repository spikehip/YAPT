...
//        listScrollView = (LinearLayout) findViewById(R.id.listlinearLayout1);
        ...
        Cursor c = dh.getSelectAllCursor(showAll);
        startManagingCursor(c);
        String[] columns =  { "ts_date", "is_period" };
        int[] viewids = {R.id.itemText1, R.id.itemImage1};
        
        this.setListAdapter(new PeriodCursorAdapter<PeriodEntity>(this, R.layout.item, c, columns, viewids));
		...
		builder.setMessage("Are you sure you want to remove today's record?")
		       ...
		       .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int id) {
					...
					((PeriodCursorAdapter<PeriodEntity>) getListView().getAdapter()).notifyDataSetChanged();
